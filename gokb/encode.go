...
func binaryDecode(_ *parameterStatus, s []byte, typ oid.Oid, cn conn) (value interface{}) {
	switch typ {
...
// EnableInfinityTs 如果没有被调用，"-infinity"和"infinity"将返回[]byte("-infinity")和[]byte("infinity")
