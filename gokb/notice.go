...
// NoticeHandlerConnector 封装了一个常规的connector并在其上设置了一个通知处理程序
type NoticeHandlerConnector struct {
	driver.Connector
	noticeHandler func(*Error)
}

// Connect 调用底层connector的connect方法然后设置通知处理程序
...
// ConnectorNoticeHandler 返回当前设置的通知处理程序(如果有的话)
...
// ConnectorWithNoticeHandler 创建或设置指定connector的指定处理程序
